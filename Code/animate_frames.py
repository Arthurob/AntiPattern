...
class App(threading.Thread):
    ...
    def run(self):
        ...
        self.root.minsize(width=str(self.root.winfo_screenwidth()), height=str(self.root.winfo_screenheight()))
    ...
    def init_UI(self):
        # Animation frames
        self.frame_animation = tk.Frame(self.root, width=900, height=800)
        self.frame_animation.grid(row=0, column=0, sticky='nw')
        # canvas
        self.canvas = tk.Canvas(self.frame_animation , width=900, height=800, bg="gray")
        self.canvas.grid(column=0, row=0, sticky='w')

        # controls frame
        self.frame_controls = tk.Frame(self.root, width=100, height=800)
        ...
        # Stop
        self.stop_button = tk.Button(self.frame_controls, text="stop", command=self.do_stop)
        self.stop_button.grid(column=2, row=0, sticky='w')
        # # Speed
        # self.delay_slider = tk.Scale(
        #     self.frame_controls, from_=0, to=1, resolution=.1, orient=tk.HORIZONTAL, variable=self.delay)
